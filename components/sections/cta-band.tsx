        ...
        >
          ...
          >
            <p className="text-sm text-muted-foreground">
              ...
              <Link href="mailto:contact@redaelhadfi.com" className="text-primary underline hover:text-accent transition-colors">
                Email me directly
              </Link>{" "}
              or connect on{" "}
              <Link href="https://linkedin.com/in/redaelhadfi" className="text-primary underline hover:text-accent transition-colors">
                LinkedIn
              </Link>.
            </p>
          </motion.div>
